package com.jam.util.identicon.generator.impl;
...
public class DefaultGenerator implements IBaseGenartor {
	...
	public Color getBackgroundColor() {
		// int r = Integer.parseInt(String.valueOf(this.hash.charAt(0)), 16) *
		// 16;
		// int g = Integer.parseInt(String.valueOf(this.hash.charAt(1)), 16) *
		// 16;
		// int b = Integer.parseInt(String.valueOf(this.hash.charAt(2)), 16) *
		// 16;
	...
	public Color getForegroundColor() {
		// int r = Integer.parseInt(String.valueOf(hash.charAt(hash.length() -
		// 1)), 16) * 16;
		// int g = Integer.parseInt(String.valueOf(hash.charAt(hash.length() -
		// 2)), 16) * 16;
		// int b = Integer.parseInt(String.valueOf(hash.charAt(hash.length() -
		// 3)), 16) * 16;
		//
		// return new Color(r, g, b);
